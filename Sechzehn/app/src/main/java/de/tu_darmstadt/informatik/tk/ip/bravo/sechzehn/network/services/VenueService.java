...
public interface VenueService {
    /**
     * Get a paginated list of Venues for optional search parameters. The default sorting order is by rating descending.
     * @param page     the page number. Default: 1.
     * @param per_page the number of elements per page. Default: 10.
     * @param lat      the latitude of the point to search around. Can only be used together with lng.
     * @param lng      the longitude of the point to search around. Can only be used together with lat.
     * @param radius   the search radius around the point in km. Can only be used together with lat and lng. Default: 10.

...
public class VenueSearch {
    ...
    public Venue.Section section; //the section for quick searches Example: food. Possible values:  food , drinks , coffee , shops , arts , outdoors , sights .
    public String query;
    ...
    public VenueSearch(Integer page, Integer perPage, Double lat, Double lng, Double radius, Venue.Section section, String query, Integer price, String time, Boolean sortByDistance) {
        this.page = page;
    ...
    public Venue.Section getSection() {
        return section;
    }

    public void setSection(Venue.Section section) {
        this.section = section;
    }

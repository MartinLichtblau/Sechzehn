...
public class FriendshipDiafrag extends DialogFragment implements LifecycleRegistryOwner {
    ...
    public void onNegative(View view){
        if(status == User.FriendshipStatus.RELATING_CONFIRMED){

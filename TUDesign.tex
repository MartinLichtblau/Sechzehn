...
Since some privacy-aware users might not be happy with frequent position updates, we also provide an incognito switch. With this setting turned on, the users is not displayed on the map.
...
\cite{gson}
\subsection{ChatKit}
ChatKit for Android \cite{chatkit} is a library that is designed to simplify the UI development of websocket based chats in Android. It offers predefined components like Dialog Lists, Message Lists, and Message Input.
